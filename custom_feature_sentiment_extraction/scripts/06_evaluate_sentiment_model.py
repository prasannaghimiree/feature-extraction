...
class BertAttentionSentimentClassifier(nn.Module):
    ...
    def forward(
        ...
        return {"loss": loss, "logits": logits, "token_weights": weights}
...
def predict_sentiment(model, tokenizer, id2label, aspect, sentence):
...
def main():
    ...
    test_cases = [
        ...
        {"aspect": "battery drain", "sentence": "Battery drains too quickly even with light usage."},
        {"aspect": "performance", "sentence": "Apps open fast and multitasking is smooth."},
        {"aspect": "display", "sentence": "The display is okay, nothing special."},
        {"aspect": "design", "sentence": "The phone looks premium and feels sleek in hand."},
        {"aspect": "night photography", "sentence": "Night photography is poor and images are noisy."},
        {"aspect": "battery life", "sentence": "The battery easily lasts a full day without charging."},
        {"aspect": "screen visibility", "sentence": "Screen visibility is bad under sunlight."},
        {"aspect": "touch", "sentence": "Touch is good and responsive."},
    ]
